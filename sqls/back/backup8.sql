...
-- ----------------------------
INSERT INTO `candidatos` VALUES ('10512968', 'Edwin Souquett', 40, '04128569874', 'edwin.s@gmail.com', 'UDO', 1, 'S', NULL, 'N', '2022-02-07');
INSERT INTO `candidatos` VALUES ('16451321', 'Jesús González', 19, '04169562845', 'jesus.gon@gmail.com', 'UCAB', 3, 'S', NULL, 'N', '2022-02-07');
INSERT INTO `candidatos` VALUES ('19565412', 'Nahum Giral', 21, '04266547157', 'nahum.giral@gmail.com', 'USB', 1, 'N', NULL, 'N', '2022-02-07');
INSERT INTO `candidatos` VALUES ('26564174', 'Carlos Ternera', 21, '04249335712', 'carlitosdindo@gmail.com', NULL, NULL, NULL, NULL, 'N', '2022-02-07');
INSERT INTO `candidatos` VALUES ('27506984', 'Gustavo', 21, '04120833879', 'gustavo.dgs@gmail.com', 'UCAB', 2, 'N', '4d256a4c5463f5386f922a1d357b70ca', 'S', '2022-02-07');
INSERT INTO `candidatos` VALUES ('27562147', 'Freddy Reyes', 21, '04125894521', 'progamerfred@gmail.com', NULL, NULL, NULL, NULL, 'N', '2022-02-07');
INSERT INTO `candidatos` VALUES ('27894123', 'Jose Saad', 21, '04128593318', 'josemsaad13@gmail.com', NULL, NULL, NULL, NULL, 'N', '2022-02-07');
INSERT INTO `candidatos` VALUES ('27951469', 'Luis Barreto', 21, '04164569842', 'barreto.exe@gmail.com', 'USB', 3, 'S', NULL, 'N', '2022-02-07');
INSERT INTO `candidatos` VALUES ('28512604', 'Jesus Gutiérrez', 19, '04121178304', 'jesus.alegs@gmail.com', 'UCAB', 2, 'N', NULL, 'N', '2022-02-07');
INSERT INTO `candidatos` VALUES ('28659564', 'María Guerra', 19, '04149695471', 'maria.guerra@gmail.com', 'UDO', 3, 'N', NULL, 'N', '2022-02-07');
INSERT INTO `candidatos` VALUES ('28952146', 'Vanessa Lozano', 21, '04246589123', 'vanessitasan@gmail.com', NULL, NULL, NULL, NULL, 'N', '2022-02-07');
INSERT INTO `candidatos` VALUES ('30453753', 'Miguelanggelo Sumoza', 21, '04249125727', 'miguelanggelo21@gmail.com', NULL, NULL, NULL, NULL, 'N', '2022-02-07');
INSERT INTO `candidatos` VALUES ('32569451', 'Monica Cuaulma', 20, '04162565432', 'monica.c@gmail.com', 'UDO', 2, 'N', NULL, 'N', '2022-02-07');
INSERT INTO `candidatos` VALUES ('33541235', 'Anthony Barrios', 19, '04123254796', 'anthony.b@gmail.com', 'UBA', 1, 'S', NULL, 'N', '2022-02-07');
INSERT INTO `candidatos` VALUES ('9951411', 'Homero Gutiérrez', 52, '04128593418', 'homero.sgp@gmail.com', 'UBA', 2, 'S', 'a2eee28fccb4c5ceb44a0494cb2134c9', 'S', '2022-02-07');
...
-- Records of vacantes
-- ----------------------------
INSERT INTO `vacantes` VALUES ('00001', 1, 'Asistente administrativo remoto', NULL, 200, 2, 25, 45, 'N', '2021-09-13', '2021-09-20', '19565412', 'N', 0.00, 'S', 'N', NULL);
INSERT INTO `vacantes` VALUES ('00001', 2, 'Desarrollador C#', NULL, 350, 2, 20, 50, 'N', '2021-01-14', '2021-12-12', NULL, 'N', 0.00, 'N', 'N', NULL);
INSERT INTO `vacantes` VALUES ('00002', 1, 'Redactor creativo', NULL, 350, 1, 18, 35, 'N', '2021-03-21', '2021-06-06', '19565412', 'N', 0.00, 'N', 'N', NULL);
INSERT INTO `vacantes` VALUES ('00002', 2, 'Desarrollador Frontend', NULL, 400, 1, 25, 55, 'S', '2021-05-30', '2021-11-30', '32569451', 'N', 0.00, 'N', 'N', NULL);
INSERT INTO `vacantes` VALUES ('00003', 1, 'Diseñador de producto', NULL, 400, 2, 20, 30, 'S', '2021-06-06', '2021-11-30', '33541235', 'N', 0.00, 'N', 'N', NULL);
INSERT INTO `vacantes` VALUES ('00003', 2, 'Desrrollador JAVA', NULL, 350, 2, 18, 55, 'N', '2021-07-17', '2021-12-15', '9951411', 'N', 0.00, 'N', 'N', NULL);
INSERT INTO `vacantes` VALUES ('00003', 3, 'Asistente administrativo remoto', NULL, 250, 2, 20, 50, 'S', '2021-10-07', '2022-01-05', NULL, 'S', 0.00, 'N', 'N', NULL);
INSERT INTO `vacantes` VALUES ('00003', 4, 'Diseñador gráfico', NULL, 300, 1, 18, 50, 'N', '2021-08-20', '2021-11-20', NULL, 'N', 0.00, 'N', 'N', NULL);
INSERT INTO `vacantes` VALUES ('00003', 5, 'Disñador Frontend', NULL, 450, 1, 22, 45, 'N', '2021-11-01', '2021-12-01', NULL, 'N', 0.00, 'N', 'N', NULL);
INSERT INTO `vacantes` VALUES ('00003', 6, 'Desarrollador C#', NULL, 360, 2, 18, 50, 'S', '2021-10-18', '2021-12-31', NULL, 'N', 0.00, 'N', 'N', NULL);
INSERT INTO `vacantes` VALUES ('00004', 1, 'Diseñador Frontend', NULL, 300, 1, 21, 50, 'S', '2021-08-26', '2021-09-26', '27951469', 'N', 0.00, 'N', 'N', NULL);
INSERT INTO `vacantes` VALUES ('00005', 1, 'Diseñador gráfico', NULL, 250, 2, 18, 35, 'N', '2021-09-06', '2021-12-31', '16451321', 'N', 0.00, 'N', 'N', NULL);
INSERT INTO `vacantes` VALUES ('205463781', 1, 'En busca de traductor', 'Se necesita traductor que pueda dominar los siguientes idiomas: Inglés, Frances, Alemán y Español', 200, 2, 18, 50, 'N', '2021-10-27', '2021-11-30', NULL, 'N', 0.00, 'N', 'N', NULL);
INSERT INTO `vacantes` VALUES ('260446980', 1, 'Se busca programador frontend', 'Debe tener experiencia con react y angular.', 200, 2, 18, 50, 'N', '2021-10-27', '2021-11-30', NULL, 'N', 0.00, 'N', 'N', NULL);
INSERT INTO `vacantes` VALUES ('260446980', 2, 'Programador Frontend en React', 'Programador para realizar una pagina en React con la libreria de ChartJS', 200, 2, 18, 50, 'N', '2021-11-25', '2021-11-30', NULL, 'N', 0.00, 'N', 'N', NULL);
INSERT INTO `vacantes` VALUES ('303848664', 1, 'Community Manager para manejar cuenta de IG', 'Deberá subir 3 posts al dia durante 5 dias a la semana.', 200, 2, 18, 50, 'N', '2021-10-27', '2021-11-04', NULL, 'N', 0.00, 'S', 'N', NULL);

-- ----------------------------
-- View structure for vista1
-- ----------------------------
DROP VIEW IF EXISTS `vista1`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `vista1` AS select `v`.`empresa` AS `empresa`,`v`.`cod_v` AS `cod_v`,`v`.`nombre_v` AS `nombre_v`,`c`.`cedula` AS `cedula`,`c`.`nombre` AS `nombre`,`c`.`edad` AS `edad`,`c`.`institucion` AS `institucion`,`c`.`nivel_edu` AS `nivel_edu`,`c`.`disponibilidad_de_viajar` AS `disponibilidad_de_viajar` from ((`candidatos` `c` join `se_postulan` `sp` on(`c`.`cedula` = `sp`.`candidato`)) join `vacantes` `v` on(`sp`.`empresa` = `v`.`empresa` and `sp`.`vacante` = `v`.`cod_v`));

-- ----------------------------
-- View structure for vista2
-- ----------------------------
DROP VIEW IF EXISTS `vista2`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `vista2` AS select `vacantes`.`empresa` AS `empresa`,`vacantes`.`cod_v` AS `cod_V`,`vacantes`.`nombre_v` AS `nombre_v`,`vacantes`.`salario` AS `espectativa_salarial` from `vacantes`;
...
-- ----------------------------
-- Event structure for ev_suspenderVacantesVencidas
-- ----------------------------
DROP EVENT IF EXISTS `ev_suspenderVacantesVencidas`;
delimiter ;;
CREATE EVENT `ev_suspenderVacantesVencidas`
ON SCHEDULE
EVERY '1' DAY STARTS '2022-02-07 23:00:00'
DO CALL suspender_vacantes()
;;
delimiter ;
...
delimiter ;;
CREATE TRIGGER `tg_after_vacantes_update_actualizar_fechas` AFTER UPDATE ON `vacantes` FOR EACH ROW BEGIN
